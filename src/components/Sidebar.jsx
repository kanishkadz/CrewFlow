      ...
      <div className="flex-grow">
        ...
        <div className="mt-12">
          ...
          <p className="text-base">
            {isAdmin
              ? 'You can assign tasks to different employees & even manage them easily.'
              : 'You can view your tasks and manage your work efficiently.'}
          </p>
        </div>
      </div>

      <button onClick={handleLogout} className="flex items-center gap-2 bg-[#fbfff1] text-red-600 font-bold mt-auto border-2 border-red-500 rounded-full py-2 px-6 hover:bg-red-500 hover:text-[#fbfff1] transition-colors">
        <LogOut size={20} />
        <span>LogOut</span>
      </button>
    </div>
